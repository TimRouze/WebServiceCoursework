...
<div class="row">
    ...
    <div class="col s12 m4 l8" style="text-align:center">
        <p style="font-size:25px">The purpose of this websystem is to give to user a readable list of selected RSS feeds.
...
<div class="row">
    <div class="col s12 m4 l2"></div>
    <div class="col s12 m4 l8" style="text-align:center">
        <p style="font-size:25px"><a href="https://materializecss.com/">Materialize CSS</a> is a library that allows for visually appealing designs for websites.
...
<div class="row">
    <div class="col s12 m4 l2"></div>
    <div class="col s12 m4 l8" style="text-align:center">
        <p style="font-size:25px"><a href="https://aws.amazon.com/">Amazon Web Service</a> is a powerful platform specialised in on demand cloud computing services. AWS offers APIs, Databases, Virtual machines, etc... 
...
<div class="row">
    <div class="col s12 m4 l2"></div>
    <div class="col s12 m4 l8" style="text-align:center">
        <p style="font-size:25px"><a href="https://www.mysql.com/en/">MySql</a> is a database management system. It uses SQL as primary language and
        is open source.</p>
    </div>
    <div class="col s12 m4 l2"></div>
</div>
...
<div class="row">
    <div class="col s12 m4 l2"></div>
    <div class="col s12 m4 l8" style="text-align:center">
        <p style="font-size:25px"><a href="https://www.phpmyadmin.net/">Phpmyadmin</a> is a free software tool that allows to handle the administration of MySQL over the Web.
